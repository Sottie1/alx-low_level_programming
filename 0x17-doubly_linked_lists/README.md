...
and functions written for the pype           |
| ------------------- | ----------roject.

| Type/File           | Definition/Protot-------------------- |
| `struct dlistint_s`    | <ul><li>`int n`</li><li>`struct dlistint_s *prev`</li><li>`struct dlistint_s *new`</li></ul> |
| `typedef dlistint_t`   | `struct dlistint_s`                                                                          |
| `0-print_dlistint.c`   | `size_                                     |
| `1-dlistit print_dlistint(const dlistint_t *h);`           nt_len.c`     | `size_t dlistint_len(const dlistint_t *h);`                                                  |
| `2-add_dnodeint.c`  | `dlistint_t *add_dnodeint(dlistint_t **head, const int n);`      _end.c` | `dlistint_t *add_dnodeint_end(dlistint_t                               |
| `3-add_dnodeint **head, const int n);`                              |
| `4-free_dlistint.c`    | `void free_dlistint(dlistint_t *head);`                                                      |
| `5-get_dnodeint.c`   *head, unsigned int index);`                   |
|  | `dlistint_t *get_dnodeint_at_index(dlistint_t  `6-sum_dlistint.c`     | `int sum_dlistint(dlistint_t *head);`                                                        |
...
* **3. Addadd_dnodeint_end.c): C function that adds a new
   node at the end**
  * [3-add_dnodeint_end.c](./3-node at the end of a doubly-linked `dlistint_t` list.
  * If the function fails - returns `NULL`.
  * Otherwise - returns the address of the new element.
...
* **5. Get node at index**
  * [5-get_dnodeint.c](./5-get_dnodeint.c): C function that locates a given node of a
  doubly-linked `dlistint_t` list.
  * The parameter `index` is the index of the node to locate - indices srns `NULL`.
  * Otherwise - returns the address oftart at `0`.
  * If the node does not exist - retu the located node.
...
* **7. Insert at index**
  ...
  * The parameter `idx` is the index of the list where the new node should
  be added - indices start at `0`.therwise - returns the address of the new element.
  * If the function fails - returns `NULL`.
  * O
...
* **11. Crackme5**
t generates passwords for the
  [crackme5](https:/  * [103-keygen.c](./103-keygen.c): C function tha/github.com/holbertonschool/0x16.c) executable.
